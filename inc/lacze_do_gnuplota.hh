...
namespace PzG {
  ...
  class InfoPlikuDoRysowania {
    public:
      ...
      */
      InfoPlikuDoRysowania(const char* NazwaPliku, RodzajRysowania  RodzRys, int Szerokosc, int Kolor)
      {
     ...
     /*!
      * \brief  Udostępnia informację o kolorze linii.
      *
      *  Udostępnia informację o kolorze rysowanej linii.
      */
     ...
     */
      int  _Szerokosc;
    /*!
     * \brief Kolor użyty w rysowaniu
     *
     * Określa kolor, jaki ma być użyty
     * do rysowania obiektów graficznych.
     * Numer określa jeden z 8 pre-definiowanych kolorów
     * używanych przez gnuplot.
     */
      int _Kolor;
    /*!
